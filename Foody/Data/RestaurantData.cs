...
namespace Foody.Data
{
    public class RestaurantData
    {
        public RestaurantData()
        {
            ...
            MtSql.Helper.Insert<Restaurants>(new Restaurants { R_Title = "Korean Night Snack", R_Description = "", R_Address = "294A Middleborough Road, Blackburn South, 3130", R_Logo ="logo2.png", R_BgImg = "drawable/r2_bg.png" });
            MtSql.Helper.Insert<Restaurants>(new Restaurants { R_Title = "The Pancake Parlour", R_Description = "", R_Logo="logo3.png", R_Address = "682-690 Warrigal Road, Malvern East, 3145", R_BgImg = "drawable/r3_bg.png" });
